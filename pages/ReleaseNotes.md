...
- **SU2022.1** = 22.0.??? on Windows 64-bit, 22.0.??? on Mac 64-bit.
- **SU2022.0.1** = 22.0.??? on Windows 64-bit, 22.0.??? on Mac 64-bit.
...
* Added {Layout::AutoTextDefinition#sequence_type}
* Added {Layout::AutoTextDefinition#sequence_type=}
* Added {Layout::AutoTextDefinition::SEQUENCE_TYPE_PER_DOCUMENT}
* Added {Layout::AutoTextDefinition::SEQUENCE_TYPE_PER_PAGE}
* Added {Sketchup::ComponentDefinition#thumbnail_camera}
* Added {Sketchup::ComponentDefinition#thumbnail_camera=}
